          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label
                  htmlFor="senha"
                  className="block text-sm font-medium text-[#05326D]"
                >
                  Senha
                </label>
                {modo === "entrar" && (
                  <button
                    type="button"
                    className="text-xs text-[#00B3A4] hover:underline"
                  >
                    Esqueceu a senha?
                  </button>
                )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 bg-[#00B3A4] hover:bg-[#009e91] active:bg-[#008a7e] disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold py-2.5 rounded-lg text-sm transition-colors flex items-center justify-center gap-2"
            >
              {loading && (
                <svg
            ...
            {modo === "entrar" ? (
              <>
                ...
                <button
                  type="button"
                  onClick={() => trocarModo("cadastro")}
                  className="text-[#00B3A4] font-medium hover:underline"
                >
                  Criar conta
                </button>
              </>
